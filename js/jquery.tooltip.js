...
;(function($){ $.fn.tooltip = function(options){
	...
	var Tooltip = function(conf){
		...
		this.win = $(window);
		this.doc = $(document);
		this.animSpeed = 1;																			// cannot be 0 due do jQuery fadeTo bug
	...
	Tooltip.prototype.show = function(){ 
		...
		if (this.tooltip.is(':hidden')){
			var self = this; setTimeout(function(){self.align.call(self);}, 1);
			this.tooltip.stop(true).fadeTo(1,0).show();
	...
	Tooltip.prototype.dontHide = function(){ this.tooltip.stop(true).fadeTo(1,1); };
